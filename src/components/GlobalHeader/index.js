          ...
          [
            (
              <Link to="/" className={styles.logo} key="logo">
                <Icon type="api" className={styles.avatar} />
              </Link>
            ),
            ...
            <Dropdown overlay={menu}>
              <span className={`${styles.action} ${styles.account}`}>
                {currentUser.avatar ? (
                  ...
                  <Avatar size="small" className={styles.avatar_char} >
                    {currentUser.name.substring(currentUser.name.length - 1)}
                  </Avatar>
                )}
